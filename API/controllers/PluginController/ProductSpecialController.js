...
const ProductSpecial = require('../../models/ProductSpecial')
...
module.exports = {
    ...
    add: async (req, res) => {
        try {
            const { name,des,image_link, link, company_id } = req.body;
            ...
            var result = await ProductSpecial.create({
                ...
                company_id: "611d0d4d9153c14f035c45ed"
            });
             if (result) {
    ...
    update: async (req, res) => {
        try {
            ...
            const { id, name, des, image, link, image_link } = req.body;
