...
const ProductSpecial = require('../../models/BannerSkin')
...
module.exports = {
    ...
    add: async (req, res) => {
        try {
            const { name,des,image_link, link, company_id,image_mobile,countSkin } = req.body;
    ...
    update: async (req, res) => {
        try {
            ...
            const { id, name, des, image, link, image_link,image_mobile,countSkin } = req.body;
