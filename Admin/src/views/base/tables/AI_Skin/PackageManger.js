...
class PackageManger extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  async updateCompany() {
    ...
    const { Name, Value, Unit, Status, arrFeature_Save, moneyPrice, arrFeature_Update, isseleted,
      radio1,radio2,radio3,radio4,radio5,radio6,radio7,radio8,radio9
    } = this.state
  
     var listFilter = [
      {
        label: "Thông tin tổng quan: nhận diện tuổi da; các loại da; nốt ruồi",
        fiter1: "radio1",
        value: radio1
      },
      {
        label: "Nhận diện các dấu hiệu Lão Hoá Da",
        fiter1: "radio2",
        value: radio2
      },
      {
        label: "Nhận diện mụn và mụn viêm đỏ",
        fiter1: "radio3",
        value: radio3
      },
      {
        label: "Nhận diện quầng thâm mắt",
        fiter1: "radio4",
        value: radio4
      },
      {
        label: "Nhận diện đốm thâm nám, mụn viêm đỏ",
        fiter1: "radio5",
        value: radio5
      },
      {
        label: "Gợi ý màu phù hợp với tone màu da",
        fiter1: "radio6",
        value: radio6
      },
      {
        label: "Kết luận chi tiết",
        fiter1: "radio7",
        value: radio7
      },
      {
  ...
  async addCompany() {
    const { Name, Value, Unit, radio1,radio2,radio3,radio4,radio5,radio6,radio7,radio8,radio9, Status, moneyPrice } = this.state
  ...
  renderSelectChecked  = (valueCheckbox) => {
  ...
  render() {
    const { data, key, action, arrPagination,radio1 } = this.state;
          ...
          <Modal isOpen={this.state.modalCom} className={this.props.className}>
            ...
            <ModalBody>
              ...
              <TextFieldGroup
                field="moneyPrice"
                label="Giá trị"
                value={this.state.moneyPrice}
                placeholder={"Nhập giá gói"}
                // error={errors.title}
                onChange={e => this.onChange("moneyPrice", e.target.value)}
              // rows="5"
              />
              ...
              <TextFieldGroup
                field="Value"
                label="Thời gian sử dụng gói( tối đa 100 lượt soi/ 1 ngày"
            ...
            <div className='form-group'>
                <label  htmlFor="tag">Danh sách tính năng của gói    </label>
                  <div className ="form-check form-switch">
                  <input className="form-check-input" checked={this.state.radio1==true} type="checkbox"  onChange={ e => this.onChange("radio1", e.target.checked) }  role="switch" id="radio1"/>
                  <label className="form-check-label" for="flexSwitchCheckDefault">Thông tin tổng quan: nhận diện tuổi da; các loại da; nốt ruồi</label>
                  </div>
                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio2==true}  type="checkbox" role="switch"  onChange={ e => this.onChange("radio2", e.target.checked) } id="radio2"/>
                  <label className="form-check-label" for="flexSwitchCheckDefault">Nhận diện các dấu hiệu Lão Hoá Da </label>
                  </div>
                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio3==true}  type="checkbox" role="switch" id="radio3" onChange={ e => this.onChange("radio3", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Nhận diện mụn và mụn viêm đỏ </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio4==true} type="checkbox" role="switch" id="radio4" onChange={ e => this.onChange("radio4", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Nhận diện quầng thâm mắt </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio5==true} type="checkbox" role="switch" id="radio5" onChange={ e => this.onChange("radio5", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Nhận diện đốm thâm nám, mụn viêm đỏ </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio6==true}  type="checkbox" role="switch" id="radio6" onChange={ e => this.onChange("radio6", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Gợi ý màu phù hợp với tone màu da </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio7==true} type="checkbox" role="switch" id="radio7" onChange={ e => this.onChange("radio7", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Kết luận chi tiết </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input" checked={this.state.radio8==true}  type="checkbox" role="switch" id="radio8" onChange={ e => this.onChange("radio8", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Tư vấn tổng quan </label>
                  </div>

                  <div className ="form-check form-switch">
                  <input className="form-check-input"  checked={this.state.radio9==true} type="checkbox" role="switch" id="radio9" onChange={ e => this.onChange("radio9", e.target.checked) } />
                  <label className="form-check-label" for="flexSwitchCheckDefault">Gợi ý sản phẩm </label>
                  </div>
