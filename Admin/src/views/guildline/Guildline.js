...
class Guildline extends Component {
  constructor(props) {
    super(props);
 ...
 async dataListBeauty ()
 {
  ...
  var baseUrlapi = Constants.BASE_URL;
    let url = baseUrlapi + "/api/settingBanner/getall";
 ...
 async getDataConfigWeb() {
    ...
    var baseUrlapi = Constants.BASE_URL;
    let url = baseUrlapi + "/api/settingBanner/getInfo";
  ...
  SaveAllConfigWeb = async (change) => {
    ...
    var baseUrlapi = Constants.BASE_URL;
    let url = baseUrlapi + "/api/settingBanner/update";
    const newComany_id = this.state.company_id;
    let Output_newComany_id;
    if (newComany_id) {
      Output_newComany_id = newComany_id;
